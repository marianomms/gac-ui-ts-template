...
module.exports = {
  ...
  globals: {
    'ts-jest': {
      // Allow last Typescript versions
      babelConfig: true
    }
  },
  ...
  // Mock all the css/scss includes and files includes
  moduleNameMapper: {
    // eslint-disable-next-line max-len
    '\\.(jpg|jpeg|png|gif|eot|otf|webp|svg|ttf|woff|woff2|mp4|webm|wav|mp3|m4a|aac|oga)$': '<rootDir>/src/__spec_helper__/file-transformer.js',
  ...
  setupFilesAfterEnv: ['<rootDir>/src/__spec_helper__/index.js'],
